...
public class Task4 {
    ...
    private static final String DIRECTORY_PATH = "java/by/it/academy/homework/lesson6/io4/";
    private static final String RESULT_FILE_NAME = "result.txt";
    private static final String FILE_EXTENSION = ".txt";
    private static final String INPUT_FILE_FULL_PATH = "java/by/it/academy/homework/lesson6/io2/text.txt";
